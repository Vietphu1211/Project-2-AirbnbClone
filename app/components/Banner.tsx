  ...
  return (
    <div className='relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[500px]'>
        ...
        <div className='absolute top-1/2 w-full text-center'>
            ...
            <button 
            type='button'
            className='text-purple-500 bg-white px-10 py-4 shadow-md rounded-full font-bold my-3 hover:shadow-xl active:scale-90 transition duration-150 '>I am flexible</button>
        </div>
    </div>
  )
}
